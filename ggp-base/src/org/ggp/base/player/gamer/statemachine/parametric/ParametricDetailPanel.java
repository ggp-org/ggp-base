...
public class ParametricDetailPanel extends DetailPanel {
	...
	public ParametricDetailPanel() {
        ...
        counterChartPanel.setPreferredSize(new Dimension(400, 200));
        sidePanel.add(counterChartPanel);
        
        new AddDataPointThread().start();		
		
		this.add(new JScrollPane(moveTable, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED), new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(5, 5, 5, 5), 5, 5));
		this.add(sidePanel, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(5, 5, 5, 5), 5, 5));
	}
