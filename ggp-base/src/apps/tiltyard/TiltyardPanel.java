...
public final class TiltyardPanel extends JPanel {
    private static void createAndShowGUI(TiltyardPanel playerPanel) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final TiltyardPanel tiltyardPanel = new TiltyardPanel();
    ...
    private AbstractAction sourceButtonMethod(final TiltyardPanel tiltyardPanel)
    {
        return new AbstractAction("Source")
        {
            public void actionPerformed(ActionEvent evt)
            {
                ...
                if (fileChooser.showOpenDialog(TiltyardPanel.this) == JFileChooser.APPROVE_OPTION)
                {                   
                    try {
