  ...
  <div>
    ...
    <xsl:attribute name="style">display:none</xsl:attribute>
        ...
        <div id="board">
    	    ...
    	    <div id="cell">
    	      <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='2' and argument[3]='wp']"><div id="valid"><img src="images/Checkers/red_pawn.png"></img></div></xsl:if>
    	      <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='2' and argument[3]='wk']"><div id="valid"><img src="images/Checkers/red_king.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='2' and argument[3]='bp']"><div id="valid"><img src="images/Checkers/black_pawn.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='2' and argument[3]='bk']"><div id="valid"><img src="images/Checkers/black_king.png"></img></div></xsl:if>
            </div>
    	    ...
    	    <div id="cell">
    	      <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='4' and argument[3]='wp']"><div id="valid"><img src="images/Checkers/red_pawn.png"></img></div></xsl:if>
    	      <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='4' and argument[3]='wk']"><div id="valid"><img src="images/Checkers/red_king.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='4' and argument[3]='bp']"><div id="valid"><img src="images/Checkers/black_pawn.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='4' and argument[3]='bk']"><div id="valid"><img src="images/Checkers/black_king.png"></img></div></xsl:if>
            </div>
    	    ...
    	    <div id="cell">
    	      <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='6' and argument[3]='wp']"><div id="valid"><img src="images/Checkers/red_pawn.png"></img></div></xsl:if>
    	      <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='6' and argument[3]='wk']"><div id="valid"><img src="images/Checkers/red_king.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='6' and argument[3]='bp']"><div id="valid"><img src="images/Checkers/black_pawn.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='6' and argument[3]='bk']"><div id="valid"><img src="images/Checkers/black_king.png"></img></div></xsl:if>
            </div>
    	    ...
    	    <div id="cell">
    	      <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='8' and argument[3]='wp']"><div id="valid"><img src="images/Checkers/red_pawn.png"></img></div></xsl:if>
    	      <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='8' and argument[3]='wk']"><div id="valid"><img src="images/Checkers/red_king.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='8' and argument[3]='bp']"><div id="valid"><img src="images/Checkers/black_pawn.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='g' and argument[2]='8' and argument[3]='bk']"><div id="valid"><img src="images/Checkers/black_king.png"></img></div></xsl:if>
            </div>

    	    <div id="cell">
    	      <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='1' and argument[3]='wp']"><div id="valid"><img src="images/Checkers/red_pawn.png"></img></div></xsl:if>
    	      <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='1' and argument[3]='wk']"><div id="valid"><img src="images/Checkers/red_king.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='1' and argument[3]='bp']"><div id="valid"><img src="images/Checkers/black_pawn.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='1' and argument[3]='bk']"><div id="valid"><img src="images/Checkers/black_king.png"></img></div></xsl:if>
            </div>
    	    ...
    	    <div id="cell">
    	      <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='3' and argument[3]='wp']"><div id="valid"><img src="images/Checkers/red_pawn.png"></img></div></xsl:if>
    	      <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='3' and argument[3]='wk']"><div id="valid"><img src="images/Checkers/red_king.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='3' and argument[3]='bp']"><div id="valid"><img src="images/Checkers/black_pawn.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='3' and argument[3]='bk']"><div id="valid"><img src="images/Checkers/black_king.png"></img></div></xsl:if>
            </div>
    	    ...
    	    <div id="cell">
    	      <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='5' and argument[3]='wp']"><div id="valid"><img src="images/Checkers/red_pawn.png"></img></div></xsl:if>
    	      <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='5' and argument[3]='wk']"><div id="valid"><img src="images/Checkers/red_king.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='5' and argument[3]='bp']"><div id="valid"><img src="images/Checkers/black_pawn.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='5' and argument[3]='bk']"><div id="valid"><img src="images/Checkers/black_king.png"></img></div></xsl:if>
            </div>
    	    ...
    	    <div id="cell">
    	      <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='7' and argument[3]='wp']"><div id="valid"><img src="images/Checkers/red_pawn.png"></img></div></xsl:if>
    	      <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='7' and argument[3]='wk']"><div id="valid"><img src="images/Checkers/red_king.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='7' and argument[3]='bp']"><div id="valid"><img src="images/Checkers/black_pawn.png"></img></div></xsl:if>
              <xsl:if test="fact[relation='cell' and argument[1]='h' and argument[2]='7' and argument[3]='bk']"><div id="valid"><img src="images/Checkers/black_king.png"></img></div></xsl:if>
            </div>
