...
public final class KioskStopRequestThread extends Thread
{
	...
	public KioskStopRequestThread(KioskGameServer gameServer, Match match, List<Move> previousMoves, Role role, String host, int port, String playerName)
	{
